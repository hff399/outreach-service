...
export type SequenceStepType =
  ...
  | 'status_change' // Change lead status
...
export type SequenceStep = {
  ...
  delay_minutes: number; // Delay before this step
  conditions?: StepCondition[]; // Conditions to execute this step
  ...
  reminder?: {
    title: string;
    due_minutes: number; // Minutes from now
